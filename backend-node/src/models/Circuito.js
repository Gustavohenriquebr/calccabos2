...
const CircuitoSchema = new mongoose.Schema(
  {
    ...
    tensao:       { type: Number, default: 380 },
    potencia_kw:  { type: Number, required: true },
    potencia_kva: { type: Number, default: null },
    fator_potencia:       { type: Number, default: 0.85 },
    distancia_m:          { type: Number, required: true },
    tipo_cabo: {
      type: String,
      enum: ['CU-PVC', 'CU-XLPE', 'AL-PVC', 'AL-XLPE'],
      default: 'CU-PVC',
    },
    temp_ambiente:  { type: Number, default: 30 },
    fases:          { type: Number, default: 3 },
    agrupamento:    { type: Number, default: 1 },
    corrente_ac_dc: { type: String, default: 'AC' },
    fator_demanda:           { type: Number, default: 1.0 },
    fator_eficiencia:        { type: Number, default: 1.0 },
    metodo_instalacao:       { type: String, default: 'TRAY' },
    formacao:                { type: Number, default: 1 },
    comprimento_real:        { type: Number, default: null },
    queda_tensao_alimentador:{ type: Number, default: 0.0 },
    isc_local:               { type: Number, default: null },
    usar_kva_informado:      { type: Boolean, default: false },
    configuracao_eletrica:   { type: String, default: null },
    referencia_tensao:       { type: String, default: null },
    modo_entrada:            { type: String, default: null },
    base_potencia:           { type: String, default: null },
    corrente_informada:      { type: Number, default: null },
    aplicacao_circuito:      { type: String, default: null },
    secao_minima_aplicacao:  { type: Number, default: null },
    secao_minima_mecanica:   { type: Number, default: null },
    queda_tensao_limite:     { type: Number, default: null },

    // ── Dados executivos de entrada ────────────────────────────────────────
    tag:              { type: String, default: null },
    from_barramento:  { type: String, default: null },
    to_equipamento:   { type: String, default: null },
    protection_device:{ type: String, default: null },
    modo_dimensionamento:       { type: String, default: 'manual' },
    modo_selecao_componentes:   { type: String, default: 'manual' },
    disjuntor_tensao_nominal:   { type: Number, default: null },
    disjuntor_corrente_nominal: { type: Number, default: null },
    disjuntor_icu:              { type: Number, default: null },
    disjuntor_curva:            { type: String, default: null },
    disjuntor_fabricante:       { type: String, default: null },

    // ── Campos MT/AT ───────────────────────────────────────────────────────
    classe_tensao_kv:   { type: Number, default: null },
    nbi_kv:             { type: Number, default: null },
    tafi_ka:            { type: Number, default: null },
    sequencia_operacao: { type: String, default: null },
    meio_extincao:      { type: String, default: null },
    tipo_acionamento:   { type: String, default: null },
